		...
		<div class="navbar-content scroll-div ">
			...
			<ul class="nav pcoded-inner-navbar ">
				...
				<?php if ($this->session->userdata('role') === '1') : ?>
					...
					<li class="nav-item">
						<a href="<?= base_url('admin/upload_image/upload_image_view'); ?>" class="nav-link "><span class="pcoded-micon"><i class="fa-solid fa fa-ad" style="color:white;"></i></span><span class="pcoded-mtext">UPLOAD IMAGE</span></a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url('admin/news/news_view'); ?>" class="nav-link "><span class="pcoded-micon"><i class="fa-solid fa fa-newspaper" style="color:white;"></i></span><span class="pcoded-mtext">MARKET OUTLOOK</span></a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
						<a href="<?= base_url('admin/trade/trade_view'); ?>" class="nav-link "><span class="pcoded-micon"><i class="fa-solid fa fa-handshake" style="color:white;"></i></span><span class="pcoded-mtext">TRADE IDEAS</span></a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url('admin/analysis/analysis_view'); ?>" class="nav-link "><span class="pcoded-micon"><i class="fa-solid fa fa-search" style="color:white;"></i></span><span class="pcoded-mtext">WEEKLY ANALYSIS</span></a>
					</li>
					<li class="nav-item">
				...
				<?php if ($this->session->userdata('role') === '3') : ?>
					<li class="nav-item">
						<a href="<?= base_url('admin/upload_image/photobank_view'); ?>" class="nav-link "><span class="pcoded-micon"><i class="fa-solid fa fa-pencil-alt" style="color:white;"></i></span><span class="pcoded-mtext">PHOTO BANK</span></a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url('admin/author_profile/author_profile_view'); ?>" class="nav-link "><span class="pcoded-micon"><i class="fa-solid fa fa-user" style="color:white;"></i></span><span class="pcoded-mtext">AUTHOR PROFILE</span></a>
					</li>
