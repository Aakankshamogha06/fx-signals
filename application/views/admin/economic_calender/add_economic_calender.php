        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="<?= base_url('economic_calender/economic_calender_submit_data'); ?>" enctype="multipart/form-data">
