        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                   <form class="form-horizontal" method="post" action="<?= base_url('author_pricing_features/author_pricing_features_submit_data'); ?>" enctype="multipart/form-data">
                       ...
                       <div class="widget-footer text-left">
                           ...
                           <button type="submit" name="submit" value="Add author_pricing_features" class="btn btn-primary " style="margin: 10px;">Add</button>
