                        ...
                        <form class="form-horizontal" method="post" action="<?= base_url('trading_signals/trading_signals_submit_data'); ?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="action" class="form-control" id="action" placeholder="Action" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="exit_point" class="form-control" id="exit_point" placeholder="Exit Point" required>
                                </div>
                            </div>
