<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <?php foreach ($view_news_category as $row) :

                    ?>
                        <div class="card-header">
                            <h5>Edit news_category</h5>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="post" action="<?= base_url('news_category/news_category_update_data'); ?>" enctype="multipart/form-data">
