<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <?php foreach ($view_calender as $row) :
                    ...
                    ?>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="post" action="<?= base_url('calender/calender_update_data'); ?>" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="widget-footer text-left">
                                        ...
                                        <button type="submit" name="submit" value="update calender" class="btn btn-primary " style="margin: 10px;">Update</button>
