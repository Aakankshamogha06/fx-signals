                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="<?= base_url('author/author_submit_data'); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputEmail4" class="form-label">Sample Article<span class="text-danger">*</span> </label>
                                <input type="file" name="sample_article" parsley-trigger="change" class="form-control" id="sample_article" placeholder="Sample Article " required>
                            </div>
                            <div class="form-group col-md-6">
